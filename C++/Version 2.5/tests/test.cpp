...
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
//             EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][4]));
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][0]));
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
...
//                 // Test strategy
//                 blackjack_strategy(testUser, testUser->GetCurrentHands()->RetrieveNode(0)->data, testDealer, false, false);
//                 EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
//                 EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][4]));
//                 EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][0]));
//                 EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
//                 testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->ClearHashTable();
...
//         if (i == 3 || i == 4 || i == 5) {
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][4]));
//             EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][0]));
//             EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
//         }
...
//                     EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
//                     EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][4]));
//                     EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][0]));
//                     EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
//                 }
//                 else if (j >= 3 && j <= 6) {
//                     EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
...
//             {
//                 // Can't split
//                 testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->AddToTable(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][4]);
//                 // Test strategy
//                 blackjack_strategy(testUser, testUser->GetCurrentHands()->RetrieveNode(0)->data, testDealer, false, false);
//                 EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
//                 EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][4]));
...
//                 EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
//                 // Can split
//                 testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->RemoveElement(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][4]);
//                 testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->ClearHashTable();
//             }
//             testDealer->GetCurrentHands()->RetrieveNode(0)->data->GetPlayerCards()->RemoveNode(-1);
//         }
...
//                 // Can't split
//                 {
//                     testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->AddToTable(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][3]);
//                     // Test strategy
//                     blackjack_strategy(testUser, testUser->GetCurrentHands()->RetrieveNode(0)->data, testDealer, false, false);
//                     if ((i >= 1 && i <= 2) || (i == 0 || i >= 6)) {
//                         EXPECT_FALSE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[2][3]));
...
//                         EXPECT_TRUE(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->Contains(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][1]));
//                     }
//                     testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->RemoveElement(testUser->GetCurrentHands()->RetrieveNode(0)->data->GetTableMatrix()[3][3]);
//                     testUser->GetCurrentHands()->RetrieveNode(0)->data->GetHashTable()->ClearHashTable();
//                 }
//                 testDealer->GetCurrentHands()->RetrieveNode(0)->data->GetPlayerCards()->RemoveNode(-1);
//             }
