...
Hand update_stats(Hand& input); // 9
Hand csv_stats(Hand& input); // 10
std::tuple<Hand, Hand, Shoe> deal_hand(Hand& playerHand, Hand& dealerHand, Shoe& shoe); // 1
void blackjack_strategy(Hand& playerHand, Hand& dealerHand); // 11
std::tuple<Hand, Hand, Shoe, bool> dealer_showing_ace(Hand& playerHand, Hand& dealerHand, Shoe& shoe); // 2
