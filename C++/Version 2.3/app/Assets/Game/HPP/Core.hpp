...
*/
std::tuple<std::shared_ptr<Hand>, std::shared_ptr<Hand>, std::shared_ptr<Shoe>> hand_logic(std::shared_ptr<Hand>& playerHand, std::shared_ptr<Hand>& dealerHand, std::shared_ptr<Shoe>& shoe) {
            ...
            while (true) {
                ...
                if (cont_play == "y") {
                    ...
                    if (gameShoe->GetCardsInShoe()->GetSize() >= min_card_count) {
                        std::cout << std::endl << gameShoe->GetCardsInShoe()->GetSize() << " cards left in shoe." << std::endl; time_sleep(SHORT_TIME_SLEEP);
                        std::cout << std::endl << "Dealing new hands." << std::endl; time_sleep(MEDIUM_TIME_SLEEP);
                        clear_terminal();
                        break;
                    }
                    // Shoe must be reshuffled
                        ...
                        std::cout << std::endl << gameShoe->GetCardsInShoe()->GetSize() << " cards left in shoe." << std::endl; time_sleep(SHORT_TIME_SLEEP);
                        std::cout << std::endl << "Shuffling a new shoe." << std::endl; time_sleep(MEDIUM_TIME_SLEEP);
                        gameShoe->EmptyShoe();
