...
- [Version 1.0]() - Version 1.0 of this application was built using Python. Users can play against a computer and can play with a fixed number of decks in the shoe. This specific release is only available to Windows users in a .exe file extension that runs in a users console.
- [Version 1.1]() - Version 1.1 of this application was also built using Python. Small changes were made in this release, primarily bug and formatting fixes. This specific release is available to Unix and Windows based operating systems in both a Unix executable and a .exe executable file.
